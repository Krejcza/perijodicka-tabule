const tableElements = {
   elements: [{
     ...
     },
     {
       ...
       skupenstvi: 'Pevný',
       fact: 'Berylium se viskytuje v některejch drahokamech. Nejbjěžnější sou smarakdy (zelená forma berylu) a akvamarýny (modrá forma berylu). Tyle drahokami sou ceněný pro svojy krásu a použývaj se v klenotňictví.',
       radioactive: false,
     ...
     },
     {
       ...
       summary: 'Uhlík jě nejzákladnějšym prvkem pro žyvot na zemi. Vitváří šyrokou škálu forem od dijamantu po grafyt a nanotrubice. Jěho unykátní chemický vlastnosťi a schopnost tvořyt složitý organycký sloučeňiny sou základem pro bijologiji, prúmysl a moderňí technologije.',
       symbol: "C",
       xpos: 14,
       ypos: 2,
       shells: [2, 4],
     ...
     },
     {
       ...
       spectral_img: null,
       summary: "Fluor jě halogen s výraznejma oksidačňíma vlastnostma a šyrokym spektrem prúmyslovejch aplykací. Je nezbytnej pro vírobu chemikálijí, skla a elektronyky a má dúležytou roli v zubňim zdravý díky fluoridúm, kerý posylujou zubňí sklovynu a chráněj přet zubnim kazem.",
       symbol: "F",
       xpos: 17,
       ypos: 2,
       shells: [2, 7],
     ...
     },
     {
       ...
       summary: "Neon je jedňim z inertňích plinú, coš znamená, že témněř nevikazuje chemickou reaktyvitu. Ve svojy čistý formně je neon bezbarvej, neprúhlednej a neňí ho možný cýtit aňi chutnat.",
       symbol: "Ne",
       xpos: 18,
       ypos: 2,
       shells: [2, 8],
       ...
       kategorie: 'Vzácný plyny',
       skupenstvi: 'Plynový',
       fact: 'Neon se často použývá ve svjetelnejch reklamách a značeňí, kde se elektryckym proudem přiváďí do víbojek, čymž vitváří charakterystický svjětelný zářeňí rúznejch baref.',
       radioactive: false,
